      ...
      <div className="w-full max-w-sm flex flex-col items-center relative z-10">
        <div className="w-full mt-4 flex flex-col items-center">
          ...
          <Link to="/signup" className="text-gray-400 hover:text-white transition-colors flex items-center justify-center gap-2 text-sm mb-10 group">
            Don't have an account? <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </Link>
          ...
          <form className="w-full space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <Button type="submit" className="w-full mt-2 py-2.5 text-base font-medium">
              Sign in
            </Button>
          </form>
        </div>
