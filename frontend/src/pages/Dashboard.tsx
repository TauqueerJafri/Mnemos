...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-[#0a0a0a] font-sans text-gray-100 selection:bg-cyan-500/30 overflow-hidden">
      <Sidebar />

      {/* Main Content */}
      <main className="flex-1 flex flex-col overflow-hidden relative min-w-0">
        {/* Background glow */}
        <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] bg-cyan-500/5 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="flex-1 overflow-y-auto p-8 pt-0 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Card 1 */}
            <Card hoverColor="cyan">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-[#1a1a1a] rounded-lg text-gray-400 group-hover:text-cyan-400 transition-colors">
                ...
                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <button className="p-1.5 text-gray-500 hover:text-red-400 hover:bg-red-400/10 rounded-md transition-colors"><X className="w-3.5 h-3.5" /></button>
                </div>
              </div>
              <h3 className="text-xl font-bold mb-4 text-white group-hover:text-cyan-50 transition-colors">Future Projects</h3>
              <ul className="space-y-3 text-gray-400 mb-8">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-cyan-500/50 mt-2 shrink-0" />
              ...
              <div className="flex items-center justify-between mt-auto">
                <div className="flex gap-2">
                  <Tag color="cyan">#productivity</Tag>
                  <Tag color="cyan">#ideas</Tag>
                </div>
            ...
            <Card hoverColor="purple">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-[#1a1a1a] rounded-lg text-gray-400 group-hover:text-purple-400 transition-colors">
              ...
              <div className="bg-[#1a1a1a] rounded-xl h-40 mb-6 flex items-center justify-center border border-gray-800/50 group-hover:border-purple-500/20 transition-colors relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mt-auto">
                <div className="flex gap-2">
                  <Tag color="purple">#productivity</Tag>
                  <Tag color="purple">#learning</Tag>
                </div>
